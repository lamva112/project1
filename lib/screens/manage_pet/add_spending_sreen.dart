...
class AddPendingSreen extends StatefulWidget {
  AddPendingSreen({Key? key}) : super(key: key);

  @override
  State<AddPendingSreen> createState() => _AddPendingSreenState();
}

class _AddPendingSreenState extends State<AddPendingSreen> {
        ...
        onPressed: () async {
          if (_medicalKey.currentState!.validate()) {
            ...
            final bool _vaccineEntryResponse =
                await _cloudStoreDataManagement.addPending(
              num: _money.text,
              note: _note.text,
            );
